...
├── logo.png                      # Logo 圖片
├── 快速開始.md                    # 快速開始指南
├── 手動中獎名單功能說明.md          # 手動設定功能詳細說明
├── 測試指南.md                    # 測試步驟與檢查清單
├── 更新日誌.md                    # 版本更新記錄
└── examples/
    ├── employees.csv             # 員工範例檔案
    └── prizes.csv                # 獎品範例檔案
```

## 📚 文件

- **[快速開始.md](快速開始.md)** - 快速上手指南，5分鐘開始使用
- **[手動中獎名單功能說明.md](手動中獎名單功能說明.md)** - 手動設定功能的完整說明
- **[測試指南.md](測試指南.md)** - 功能測試步驟與檢查清單
- **[更新日誌.md](更新日誌.md)** - 版本更新內容與技術細節
